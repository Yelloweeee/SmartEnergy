...
if (els.zone) els.zone.textContent = ZONE;
...
function setDataMode(live) {
  ...
  if (els.footerSource) {
    els.footerSource.textContent = live ? `live Electricity Maps - zone ${ZONE}` : "simulated fallback";
  }
}
